...
- 默认测试：`123 passed, 2 deselected`，无 TestClient/httpx 弃用警告
- 真实 Neo4j/Ollama integration：`2 passed, 123 deselected`
- 新 200 道菜版本构建、激活、dry-run、验证回滚和最终版本恢复均成功
- Neo4j：6 个命名唯一约束、1 个 Recipe 版本索引；两个保留版本各 200 道菜
- 清理 dry-run：活动/上一版本均受保护，候选、无效目录和 graph-only 版本均为 `0`
